...
CREATE TABLE MODELE(ID INT GENERATED BY DEFAULT AS IDENTITY NOT NULL , ID_CREE INT NOT NULL , ID_POSSEDE INT NOT NULL , NOM VARCHAR(32), DESCRIPTION VARCHAR(255), CONSTRAINT PK_MODELE PRIMARY KEY (ID))
...
ALTER TABLE MODELE ADD CONSTRAINT FK_MODELE_CONSTRUCTEUR FOREIGN KEY (ID_CREE) REFERENCES CONSTRUCTEUR(ID)
